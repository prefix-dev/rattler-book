...
If you are thinking about building a package manager for your own language, the [Adapting to Your Language](deep-dive-adapting.md) deep dive maps out which pieces transfer directly and where you would need to diverge. The short version: [chapters 1](ch01-what-is-a-package-manager.md) through [9](ch09-run.md) are language-agnostic, and [chapter 10](ch10-build.md) is where you make it your own.
